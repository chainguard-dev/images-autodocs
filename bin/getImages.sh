...
chainctl img ls -ojson --parent=$GROUP_PUBLIC > ${OUTPUT_PATH}/images-tags-dev.json 2>&1
echo "Fetching production images list...";
chainctl img ls -ojson --parent=$GROUP_PRIVATE > ${OUTPUT_PATH}/images-tags-prod.json 2>&1
echo "Finished.";
